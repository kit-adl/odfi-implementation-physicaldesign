...
odfi::nx::Class create NMOS -superclass odfi::scenegraph::Group {
    ...
    :public method mapNode select {
        ...
        if {$select=="::odfi::scenegraph::svg::SVGNode"} {
            ...
            ## Parameters
            set numberofDS [expr ${:fingers}+${:fingers}%2]
            ...
            return [:group "[:parent] getName" {
                ...
                ##################
                :rect {
                     ::repeatf [expr ${:fingers}+1] {
                        
                        :rect {
                             :color set green                        
                             :height ${:fingerWidth}
                             :width  ${:contactWidth}
                             :setX [expr $i*(${:contactWidth}+${:length})] 
                             :setY 0
                             :depth $nPlusDepth                             
                        }  
                     ...
                     ## Reverse Z to put DS on top of substrate
                ...
                ::repeatf ${:fingers} {
                    ...
                    :rect {
                         ...
                         :setX [expr ${:contactWidth}+$i*2*${:contactWidth}]
                         :setY 0   
                         :setZ $substrateDepth                      
                 ...
                 ::repeatf [expr ${:fingers}+1] {
                     ...
                     ::repeat $numberofContacts {
                         ...
                         :rect {
                             ...
                             #:z 5   
                             :depth 2 
                             :setX [expr $middlepos + ($ci*(${:contactWidth}+${:length}))] 
                             :setY  [expr $i*(${:contactSize}+${:contactSize})]
                             :setZ $substrateDepth                                         
                         }    
                     }                         
